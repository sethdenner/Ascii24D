...
namespace Engine.Input
{
    ...
    public class Input
    {
        ...
        /// </param>
        /// <param name="update">
        /// <paramref name="update"/> is the <c>SharpDX.DirectInput.KeyboardUpdate</c> 
        /// object containing event data for the keyboard state change.
        /// </param>
        public delegate void KeyboardMessage(IInputDevice device, KeyboardUpdate update);
        /// <summary>
        ...
        /// </param>
        public delegate void MouseMessage(IInputDevice device, MouseUpdate update);
        /// <summary>
        ...
        /// </param>
        /// <param name="update">
        /// <paramref name="update"/> is the <c>SharpDX.DirectInput.JoystickUpdate</c>
        /// object containing event data for the Joystick state change.
        /// </param>
        public delegate void JoystickMessage(IInputDevice device, JoystickUpdate update);
        /// <summary>
        /// <c>NewDeviceMessage</c> delegate. Register a callback function matching this
        /// method signature to be notified when a new device is connected.
        /// </summary>
        ...
        /// </param>
        public delegate void NewDeviceMessage(Guid deviceGuid, DeviceType deviceType);
        /// <summary>
        /// <c>LostDeviceMessage</c> delegate. Register a callback function matching this
        /// method signature to be notified when connection to a device is lost..
        /// </summary>
        /// <param name="deviceGuid">
        ...
        /// </param>
        public delegate void LostDeviceMessage(Guid deviceGuid, DeviceType deviceType);
        /// <summary>
        /// <c>Input</c> constuctor. Intializes standard collection members to empty
        /// collections. Instantiates the <c>DirectInput</c> wrapper instance.
        /// </summary>
        ...
        /// <summary>
        /// <c>EnumerateDevices</c> uses the <c>DirectInput</c> wrapper to iterate through
        /// all of the devices that can be seen by <c>SharpDX.DirectInput</c>. This method
        /// only enumerates mouse, keyboard and joystick devices. For joysticks
        /// <c>SharpDX.DirectInput.DeviceType.Joystick</c>,
        /// <c>SharpDX.DirectInput.DeviceType.Gamepad</c> and
        /// <c>SharpDX.DirectInput.DeviceType.FirstPerson</c> are all supported. To support
        /// other device types extend this method.
        /// </summary>
        ...
        /// <summary>
        /// The <c>Update</c> method iterates over all enumerated devices, polls DirectInput
        /// for all queued state updates and saves them into the corresponding <c>InputState</c>
        /// manager that matches each device <c>Guid</c>.
        /// </summary>
        public void Update()
        { 
        ...
        /// an enumerated device of the type specified for use in the application.
        /// </summary>
        /// <param name="deviceType">
        ...
        /// <summary>
        /// <c>_inputDevices</c> is a <c>List</c> of <c>InputDevice</c> instances
        /// representing all supported and enumarated devices connected to the system.
        /// </summary>
